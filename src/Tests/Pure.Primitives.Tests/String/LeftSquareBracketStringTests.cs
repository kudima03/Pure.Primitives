...
public sealed record LeftSquareBracketStringTests
{
    [Fact]
    public void InitializeFromScalarConstructor()
    {
        IString stringPrimitive = new LeftSquareBracketString();
    ...
    {
        IEnumerable<IChar> stringPrimitive = new LeftSquareBracketString();
    ...
    {
        IEnumerable stringPrimitive = new LeftSquareBracketString();
    ...
    public void ThrowExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new LeftSquareBracketString().GetHashCode()
        );
    }
    ...
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new LeftSquareBracketString().ToString()
        );
    }
}
