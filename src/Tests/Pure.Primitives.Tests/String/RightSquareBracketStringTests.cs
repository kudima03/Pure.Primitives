...
public sealed record RightSquareBracketStringTests
{
    [Fact]
    public void InitializeFromScalarConstructor()
    {
        IString stringPrimitive = new RightSquareBracketString();
    ...
    {
        IEnumerable<IChar> stringPrimitive = new RightSquareBracketString();
    ...
    {
        IEnumerable stringPrimitive = new RightSquareBracketString();
    ...
    public void ThrowExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new RightSquareBracketString().GetHashCode()
        );
    }
    ...
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new RightSquareBracketString().ToString()
        );
    }
}
