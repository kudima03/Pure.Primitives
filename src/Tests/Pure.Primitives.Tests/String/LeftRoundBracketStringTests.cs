...
public sealed record LeftRoundBracketStringTests
{
    [Fact]
    public void InitializeFromScalarConstructor()
    {
        IString stringPrimitive = new LeftRoundBracketString();
    ...
    {
        IEnumerable<IChar> stringPrimitive = new LeftRoundBracketString();
    ...
    {
        IEnumerable stringPrimitive = new LeftRoundBracketString();
    ...
    public void ThrowExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new LeftRoundBracketString().GetHashCode()
        );
    }
    ...
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new LeftRoundBracketString().ToString()
        );
    }
}
