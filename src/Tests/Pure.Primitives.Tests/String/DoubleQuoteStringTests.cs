...
public sealed record DoubleQuoteStringTests
{
    [Fact]
    public void InitializeFromScalarConstructor()
    {
        IString stringPrimitive = new DoubleQuoteString();
    ...
    {
        IEnumerable<IChar> stringPrimitive = new DoubleQuoteString();
    ...
    {
        IEnumerable stringPrimitive = new DoubleQuoteString();
    ...
    public void ThrowExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new DoubleQuoteString().GetHashCode()
        );
    }
    ...
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new DoubleQuoteString().ToString()
        );
    }
}
