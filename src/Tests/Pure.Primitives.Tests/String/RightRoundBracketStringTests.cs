...
public sealed record RightRoundBracketStringTests
{
    [Fact]
    public void InitializeFromScalarConstructor()
    {
        IString stringPrimitive = new RightRoundBracketString();
    ...
    {
        IEnumerable<IChar> stringPrimitive = new RightRoundBracketString();
    ...
    {
        IEnumerable stringPrimitive = new RightRoundBracketString();
    ...
    public void ThrowExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new RightRoundBracketString().GetHashCode()
        );
    }
